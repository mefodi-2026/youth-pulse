...
type AudienceProps = { phase: keyof typeof phaseLabels; drawOrder: WheelDrawOrder; round?: WheelPublicRound; activeSpin?: WheelSpinAnimation; history?: WheelPublicHistoryItem[]; nameCount: number; taskCount: number; roundCount: number; pendingCount: number; idleItems?: WheelSpinItem[]; stopAnimation?: boolean; showReveal?: boolean }

function WheelAudiencePanel({ phase, drawOrder, round, activeSpin, history = [], nameCount, taskCount, roundCount, pendingCount, idleItems = [], stopAnimation = false, showReveal = true }: AudienceProps) {
